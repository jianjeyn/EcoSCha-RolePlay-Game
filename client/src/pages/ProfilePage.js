...
const user = {
  name: "Nashwa Nadria Futi",
  email: "nashwa.nadria@upi.edu",
  // avatar: "/assets/images/avatar.png", // Use your avatar path if needed
};

const achievements = [null, null, null, null]; // Placeholder for 4 achievements
    ...
    <div className="min-h-screen bg-[#F6FFD7] pb-8 relative z-[0]">
      ...
      <div className="mt-6 w-full max-w-2xl mx-auto">
        ...
        <div className="flex justify-center">
          <div className="flex items-center space-x-6">
            <button className="text-[#6B7A2C] text-2xl font-bold">
              &#8592;
            </button>
            {achievements.map((ach, idx) => (
              <div
                key={idx}
                className="w-24 h-24 rounded-full bg-gray-300 flex items-center justify-center text-gray-400 text-3xl font-bold"
              >
                {/* Achievement icon or content */}
              </div>
            ))}
            <button className="text-[#6B7A2C] text-2xl font-bold">
              &#8594;
      ...
      <div className="flex justify-center mt-8">
        <div className="w-[90vw] max-w-2xl bg-[#F6FFD7] rounded-xl shadow-lg p-6">
          <div className="font-bold text-lg text-[#6B7A2C] mb-2">
            Riwayat Permainan
          </div>
                ...
                {gameHistory.map((game, idx) => (
                  ...
                  >
                    ...
                    <td
                      className="py-2 px-4"
                      style={{
                        color: game.status === "Menang" ? "#6B7A2C" : "#C0392B",
                      }}
                    >
                      {game.status}
                    </td>
      ...
      <img
        src="/assets/images/backgrounds/Background_bawah.png"
        alt=""

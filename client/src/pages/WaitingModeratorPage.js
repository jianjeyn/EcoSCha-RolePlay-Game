    ...
    <Background>
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[80vh] px-4">
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-200 font-poppins">Permainan akan segera dimulai. Silakan tunggu instruksi dari moderator.</p>
        </div>
      </main>
    </Background>
  );
...
export default WaitingModeratorPage;

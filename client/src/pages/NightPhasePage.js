      ...
      {!showNarrative && (
        <div className="flex flex-col items-center justify-center relative" style={{ height: "calc(100vh - 100px)" }}>
          <div className="relative">
            <img src="/assets/images/icons/nightphase.png" alt="Night Phase" className="w-auto h-auto max-w-lg max-h-96 object-contain" />
            <div className="absolute inset-0 flex items-center justify-center" style={{ transform: "translateY(40px)" }}>
              <h1 className="text-white text-5xl font-bold font-poppins text-center">Fase Malam</h1>
            </div>
          </div>
        </div>
      )}
